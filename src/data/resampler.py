...
def resample_and_save(input_path: str | Path, output_dir: str | Path, timeframes: list[str]) -> None:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--timeframes", nargs="+", default=["5m", "15m", "30m", "1h", "4h", "1d"])
